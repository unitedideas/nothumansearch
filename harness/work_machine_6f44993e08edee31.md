# NHS Score-Fix Private Cleanup Retry - 2026-06-01
...
Latest aggregate proof available to this executor remains the planner-provided aggregate in this WorkItem:
...
- Keep the cleanup lane open as `credential_required`.
