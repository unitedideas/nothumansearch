...
- Keep the score-fix cleanup lane open as `credential_required` for an executor where `tools/geo-jobs-redacted-read.sh` can read one of the NHS admin Keychain aliases.
