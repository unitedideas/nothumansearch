...
- `harness/generated-work-items.json` and `ops/ledgers/score-fix-internal-test-cleanup-2026-05-12.md` were updated in the worktree, but git currently marks both tracked paths assume-unchanged and this executor cannot update the index metadata.
