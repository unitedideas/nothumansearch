...
- `harness/generated-work-items.json` and `ops/ledgers/score-fix-internal-test-cleanup-2026-05-12.md` remain tracked with assume-unchanged flags in this checkout, so this executor also cannot stage their updates.
