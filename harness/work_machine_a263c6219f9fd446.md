...
- A future credential-capable executor may classify or clean up only `test_like pending` rows through the private admin workflow and must keep committed proof aggregate-only.
