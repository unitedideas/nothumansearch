# QLimit score-fix cleanup closeout - 2026-06-05T20:11:13Z
...
- The next credential-capable executor may classify or clean up only `test_like pending` rows through the private admin workflow and must keep committed proof aggregate-only by class, status, age bucket, and host class.
