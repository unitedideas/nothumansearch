...
func categorize(site *models.Site) string {
	...
	domainRules := map[string]string{
		...
		// Batch 13: 2026-05-07 top score-ranked "other" cleanup.
		// These came from the live /api/v1/search?category=other list, not a
		// seed wish-list; keep this list high confidence.
		"zgts.in":                 "health",
		"budgetfitter.uk":         "ecommerce",
		"rettfrabonden.com":       "ecommerce",
		"chartlibrary.io":         "finance",
		"bernstein.run":           "developer",
		"ansvar.eu":               "security",
		"tooloracle.io":           "developer",
		"rnwy.com":                "security",
		"bibigpt.co":              "ai-tools",
		"1trip.app":               "productivity",
		"debridge.com":            "finance",
		"businesshotels.com":      "ecommerce",
		"regenique-elegance.com":  "ecommerce",
		"farcomindustrial.com":    "ecommerce",
		"chikoh.com":              "data",
		"planharmony.com":         "productivity",
		"pinmeto.com":             "productivity",
		"opdstar.com":             "health",
		"aiagentsbay.com":         "developer",
		"suprdeck.com":            "finance",
		"cuilabs.io":              "security",
		"madeonsol.com":           "finance",
		"hefestoai.narapallc.com": "security",
		"receiptconverter.com":    "ai-tools",
		"hallucinationherald.com": "news",
		"unmarkdown.com":          "developer",
		"roundtable.now":          "ai-tools",
		"postalform.com":          "communication",
		"tianji.msgbyte.com":      "developer",
		"webzum.com":              "ai-tools",
		"certman.app":             "security",
		"lakmesalon.in":           "health",
		"p2pclaw.com":             "ai-tools",
		"copyright01.com":         "productivity",
		"txrisk.xyz":              "security",
		"plany.ae":                "productivity",
		"mpprimo.com":             "finance",
		"apimesh.xyz":             "developer",
		"sats4ai.com":             "ai-tools",
		"patpat.com":              "ecommerce",
		"webcamexplore.com":       "data",
		"simcorner.com":           "ecommerce",
		"cpfhub.io":               "security",
		"apibase.pro":             "developer",
		"datamuse.com":            "data",
		"samiolearning.com":       "education",
		"mirror-hq.com":           "ai-tools",
		"indexing.co":             "finance",
		...
		// Batch 15: 2026-05-08 business-agent cleanup of high-score "other" sites.
		// These came from the live category=other, min_score=40 API slice and are
		// limited to domains whose product/category is clear from name + description.
		"sofiastage.com":        "data",
		"arifos.arif-fazil.com": "developer",
		"brunosan.de":           "ai-tools",
		"jcm-tech.store":        "ecommerce",
		"balladic.com":          "productivity",
		"turiverde.com.br":      "ecommerce",
		"scrappycmo.com":        "productivity",
		"aibtc.news":            "news",
		"quodat.com":            "data",
		"linktr.ee":             "productivity",
		"saigontechnology.com":  "developer",
		"raider.io":             "data",
		"flashalpha.com":        "finance",
		"sgpdirectory.com":      "data",
		"checklist.day":         "productivity",
		"pasal.id":              "data",
		"brag.fast":             "communication",
		"3minapi.com":           "developer",
		"pilot-shell.com":       "developer",
		"zadroweb.com":          "developer",
		"altbots.io":            "finance",
		"basincheck.com":        "security",
		"sendameal.com":         "ecommerce",
		"meetup.com":            "communication",
		"rcponline.pl":          "productivity",
		"flyto2.com":            "productivity",
		"zenserp.com":           "data",
		"qualyhq.com":           "finance",
		"papra.app":             "productivity",
		"coordinalo.com":        "health",
		"dolarhoje.io":          "finance",
		"gitlab.wikimedia.org":  "developer",
		"buddy.works":           "developer",
		"secureframe.com":       "security",
		"padelapi.org":          "data",
		"nfusionsolutions.biz":  "finance",
		"vdo.ninja":             "communication",
		"country.is":            "data",
		"reflag.com":            "developer",
		"ki-bild-erstellen.com": "ai-tools",
		"ipstack.com":           "data",
		"victorops.com":         "communication",
		"beekeeper.io":          "communication",
		"needle.tools":          "developer",
		"tookane.com":           "productivity",
		"voltanotes.com":        "security",
		"iproyal.com":           "developer",
		"trustrails.app":        "security",
		"tikfly.io":             "developer",
		"generect.com":          "data",
		"de.fi":                 "finance",
		"launchfa.st":           "developer",
		"farmermarket.us":       "ecommerce",

		// Batch 16: 2026-05-08 business-agent cleanup of clear live "other" sites.
		// Selected from the first four live category=other pages; keep this to
		// domains whose category is clear from the captured name/description.
		"currenttimeutc.com":    "data",
		"beslim.ro":             "ecommerce",
		"murphyfurniture.ie":    "ecommerce",
		"doctornow.co.kr":       "health",
		"nhavan.vn":             "education",
		"obrienmedia.co.uk":     "developer",
		"mansetetkisi.com":      "news",
		"20lab.app":             "finance",
		"bestangro.ro":          "ecommerce",
		"wallstreetturkish.com": "finance",
		"makoto.com.pl":         "developer",
		"yubigeek.com":          "news",
		"thesansasyonel.com":    "news",
		"media.halvacard.ru":    "finance",
		"tumblr.com":            "communication",
		"sansasyonelgazete.com": "news",
		"youdeserve.today":      "productivity",
		"lowellbooks.com":       "ecommerce",
		"adstxt.guru":           "developer",
		"mebli-bristol.com.ua":  "ecommerce",
		"kieslermachine.com":    "ecommerce",
		"autogarsas.lt":         "ecommerce",
		"personly.com":          "communication",
		"nfusionsolutions.com":  "finance",
		"axial.net":             "finance",
		"giftshopie.com":        "ecommerce",
		"bucket.co":             "developer",
		"hpkv.io":               "developer",
		"hellodarwin.com":       "finance",
		"figmatoazure.com":      "developer",
		"clockify.me":           "productivity",
		"frankfurter.app":       "finance",
		"arcadia.finance":       "finance",
		"osf.io":                "data",
		"hintoai.com":           "ai-tools",
		"gamebrain.co":          "ai-tools",
	}
...
func domainRuleMatches(domain, key string) bool {
	if !strings.Contains(key, ".") {
		return strings.Contains(domain, key)
	}
	start := 0
	for {
		idx := strings.Index(domain[start:], key)
		if idx == -1 {
			return false
		}
		idx += start
		beforeOK := idx == 0 || domain[idx-1] == '.' || domain[idx-1] == '-'
		after := idx + len(key)
		afterOK := after == len(domain) || domain[after] == '.' || domain[after] == '-'
		if beforeOK && afterOK {
			return true
		}
		start = idx + 1
