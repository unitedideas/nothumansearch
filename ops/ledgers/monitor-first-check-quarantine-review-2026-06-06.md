...
Date: 2026-06-06T21:20:00Z
WorkItem: work_machine_cac2f62fa20f1138
...
No raw monitor rows were fetched. No raw monitor domains, URLs, row ids, emails, tokens, or private review notes were read or committed. No monitor admin action was applied.
...
Both readers failed closed before any admin data was fetched:

```text
missing Keychain service: nhs-admin-api-key or nothumansearch-admin-key
```

Last known aggregate input from the queued work item remains:
