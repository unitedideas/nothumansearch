...
WorkItem: work_machine_fcedfb84df6bfca3
...
No raw monitor rows were fetched. No raw monitor domains, URLs, row ids, emails, tokens, private review notes, payment identifiers, customer identifiers, or query logs were committed. No monitor admin action was applied.
...
More recent aggregate-safe planner context also reported:
